...
- `release_deposit_2026-01-16_v5_final/` — Immutable, verbatim copy of the release used as release evidence and golden-reference outputs; do not edit during development.
