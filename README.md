...
- Manuscript text and figures (the preprint and LaTeX prose): CC-BY-4.0 (see the release archive record metadata).
...
- `release_snapshot/` — Immutable, verbatim copy of the release used as release evidence and golden-reference outputs; do not edit during development.
...
### 3) Verify against release archive goldens
